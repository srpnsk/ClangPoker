...
static int sockfd = -1;
static Message message_history[100];
static int message_count = 0;
static GameAction game_history[100];
static int game_history_count = 0;
static Card player_hand[20];
static int hand_size = 0;
static PlayerInfo players[6];
static int players_count = 0;
static char game_status[100] = "Disconnected";
static int current_room = -1;
static char player_name[50] = "";
static bool my_turn = false;
static Card top_card = {COL_WILD, VAL_WILD};
static Color current_color = COL_WILD;
static bool direction_clockwise = true;
